...
#include <math.h>
#include <stdlib.h>
#include "improper_flex_elastic.h"
#include "atom.h"
#include "comm.h"
#include "neighbor.h"
#include "domain.h"
...
ImproperFlexElastic::ImproperFlexElastic(LAMMPS *lmp) : Improper(lmp)
{
  writedata = 1;
}
...
ImproperFlexElastic::~ImproperFlexElastic()
{
...
void ImproperFlexElastic::compute(int eflag, int vflag)
{
...
void ImproperFlexElastic::allocate()
{
  allocated = 1;
...
void ImproperFlexElastic::coeff(int narg, char **arg)
{
...
void ImproperFlexElastic::write_restart(FILE *fp)
{
...
void ImproperFlexElastic::read_restart(FILE *fp)
{
  allocate();
...
void ImproperFlexElastic::write_data(FILE *fp)
{
