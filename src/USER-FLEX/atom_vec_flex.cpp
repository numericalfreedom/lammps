...
AtomVecFLEX::AtomVecFLEX(LAMMPS *lmp) : AtomVec(lmp)
{
  molecular = 1;
...
void AtomVecFLEX::copy(int i, int j, int delflag)
{
  int k;
...
int AtomVecFLEX::pack_comm(int n, int *list, double *buf,
...
int AtomVecFLEX::pack_comm_vel(int n, int *list, double *buf,
                               int pbc_flag, int *pbc)
{
  int i,j,m;
...
void AtomVecFLEX::unpack_comm(int n, int first, double *buf)
{
  int i,m,last;
...
void AtomVecFLEX::unpack_comm_vel(int n, int first, double *buf)
{
  int i,m,last;
...
int AtomVecFLEX::pack_reverse(int n, int first, double *buf)
{
  int i,m,last;
...
void AtomVecFLEX::unpack_reverse(int n, int *list, double *buf)
{
  int i,j,m;
...
int AtomVecFLEX::pack_border(int n, int *list, double *buf,
                             int pbc_flag, int *pbc)
{
  int i,j,m;
  double dx,dy,dz;
...
int AtomVecFLEX::pack_border_vel(int n, int *list, double *buf,
                                 int pbc_flag, int *pbc)
{
  int i,j,m;
  double dx,dy,dz,dvx,dvy,dvz;
...
int AtomVecFLEX::pack_border_hybrid(int n, int *list, double *buf)
{
  int i,j,m;
...
void AtomVecFLEX::unpack_border(int n, int first, double *buf)
{
  int i,m,last;
...
void AtomVecFLEX::unpack_border_vel(int n, int first, double *buf)
{
  int i,m,last;
...
int AtomVecFLEX::unpack_border_hybrid(int n, int first, double *buf)
{
  int i,m,last;
...
int AtomVecFLEX::pack_exchange(int i, double *buf)
{
  int k;
...
int AtomVecFLEX::unpack_exchange(double *buf)
{
  int k;
...
int AtomVecFLEX::pack_restart(int i, double *buf)
{
  int k;
...
int AtomVecFLEX::unpack_restart(double *buf)
{
  int k;
...
void AtomVecFLEX::create_atom(int itype, double *coord)
{
  int nlocal = atom->nlocal;
  if (nlocal == nmax) grow(0);
...
void AtomVecFLEX::data_atom(double *coord, imageint imagetmp, char **values)
{
  int nlocal = atom->nlocal;
  if (nlocal == nmax) grow(0);
...
int AtomVecFLEX::data_atom_hybrid(int nlocal, char **values)
{
...
void AtomVecFLEX::pack_data(double **buf)
{
  int nlocal = atom->nlocal;
...
int AtomVecFLEX::pack_data_hybrid(int i, double *buf)
{
...
void AtomVecFLEX::write_data(FILE *fp, int n, double **buf)
{
  for (int i = 0; i < n; i++)
...
int AtomVecFLEX::write_data_hybrid(FILE *fp, double *buf)
{
...
bigint AtomVecFLEX::memory_usage()
{
  bigint bytes = 0;
